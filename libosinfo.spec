...
export LANG=C
export SOURCE_DATE_EPOCH=1503947969
%configure --disable-static --disable-vala --with-usb-ids-path={datadir}/hwdata --with-usb-pci-path={datadir}/hwdata --disable-tests
