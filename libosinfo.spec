...
Source0  : https://releases.pagure.org/libosinfo/libosinfo-1.11.0.tar.xz
Source1  : https://releases.pagure.org/libosinfo/libosinfo-1.11.0.tar.xz.asc
...
%prep
%setup -q -n libosinfo-1.11.0
cd %{_builddir}/libosinfo-1.11.0
pushd ..
cp -a libosinfo-1.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702020176
...
ninja -v -C builddir
CFLAGS="$CFLAGS -m64 -march=x86-64-v3 -Wl,-z,x86-64-v3 -O3" CXXFLAGS="$CXXFLAGS -m64 -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -m64 -march=x86-64-v3" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Denable-vala=enabled \
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libosinfo-1.0.so.0.1011.0
/usr/lib64/libosinfo-1.0.so.0
/usr/lib64/libosinfo-1.0.so.0.1011.0
